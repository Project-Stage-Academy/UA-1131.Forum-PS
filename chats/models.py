...
class Chat(models.Model):
    ...
    participants = models.ManyToManyField(CompanyAndUserRelation, related_name='chats')
...
class Message(models.Model):
    ...
    sender = models.ForeignKey(CompanyAndUserRelation, on_delete=models.CASCADE, related_name="sent_messages")
    recipient = models.ForeignKey(CompanyAndUserRelation, on_delete=models.CASCADE, related_name='received_messages')
