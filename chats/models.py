...
class Chat(models.Model):
    participants = models.ManyToManyField(CompaniesAndUsersRelations, related_name='chats')
...
class Message(models.Model):
    ...
    sender = models.ForeignKey(CompaniesAndUsersRelations, on_delete=models.CASCADE, related_name="sent_messages")
    recipient = models.ForeignKey(CompaniesAndUsersRelations, on_delete=models.CASCADE, related_name='received_messages')
